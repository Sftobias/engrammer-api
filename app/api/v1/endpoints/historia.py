...
from app.models.schemas import InvokeResponse, EndConversationRequest, EndConversationResponse, HistoryInvokeRequest
from app.services.pipeline_registry import PIPELINES
from app.api.v1.deps import get_current_tenant_id

router = APIRouter()

@router.post("/history/invoke", response_model=InvokeResponse)
def invoke_pipeline(
    req: HistoryInvokeRequest,
...
@router.post("/history/end", response_model=EndConversationResponse)
